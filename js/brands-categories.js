...
class BrandsCategoriesPage {
    ...
    getBrandImagePath(brand) {
        ...
        const brandImageMap = {
            ...
            'host defense': 'host-defense.jpg',
            'business-one': 'business-one.png',
            'business one': 'business-one.png',
            'hm-enterprise': 'business-one.png',
            'hm enterprise': 'business-one.png',
            'hm-herbs': 'business-one.png',
            'hm herbs': 'business-one.png',
    ...
    getFallbackBrands() {
        return [
            ...
            { name: 'HM Enterprise', slug: 'hm-enterprise', description: 'Business One proprietary formulations and exclusive products developed for optimal health and wellness.' },
