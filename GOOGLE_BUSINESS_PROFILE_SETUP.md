...
Business One OAuth project number (from `GBP_CLIENT_ID`): **266596824943**
...
- Apply with an email that is an **owner/manager** on the profile (e.g. `info@businessonecomprehensive.com`)
...
| Test users | `info@businessonecomprehensive.com` while app is in **Testing** |
