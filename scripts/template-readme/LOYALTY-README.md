...
Standalone backup of the Business One customer loyalty / rewards system, extracted from [hmherbs-main](../hmherbs-main).
...
Extracted from `hmherbs-main` — Business One e-commerce platform.
