...
**Business One bills merchants** (you collect revenue). **Business One is a merchant store** — it does not own this billing UI.
...
| **Business One admin** | License tab links out to Business One billing |

Form styles use `business-one-webpage/css/platform-billing.css` — **not** Business One admin CSS.
