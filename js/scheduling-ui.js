/**
 * Shared branded dialogs and toasts for Scheduling booking pages (no native alert/confirm).
 */
(function (global) {
    ...
    const SCROLL_LOCK_CLASS = 'scheduling-ui-scroll-locked';
    ...
    function showEdsConfirm({
        ...
        return new Promise((resolve) => {
            ...
            modal.className = 'scheduling-modal show eds-confirm-modal';
            modal.setAttribute('role', 'dialog');
            modal.setAttribute('aria-modal', 'true');
            modal.setAttribute('aria-labelledby', 'eds-confirm-title');

            modal.innerHTML = `
                <div class="scheduling-modal-overlay" data-eds-confirm-dismiss></div>
                <div class="scheduling-modal-content eds-confirm-content">
                    <div class="scheduling-modal-header">
                        <h2 id="eds-confirm-title">${escapeHtml(title)}</h2>
                        <button type="button" class="scheduling-modal-close" data-eds-confirm-dismiss aria-label="Close">
                            ${CLOSE_ICON_SVG}
                        </button>
                    </div>
