...
/**
 * Resend Scheduling booking confirmation (correct links after STOREFRONT_PUBLIC_URL / PORT changes).
 * Usage: node scripts/resend-scheduling-email.js <bookingId>
 */
...
async function main() {
    ...
    if (!Number.isFinite(bookingId) || bookingId < 1) {
        console.error('Usage: node scripts/resend-scheduling-email.js <bookingId>');
        process.exit(1);
    }
