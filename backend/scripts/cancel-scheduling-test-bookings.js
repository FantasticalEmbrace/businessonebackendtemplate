...
/**
 * Cancel active Scheduling bookings by id (for clearing test data).
 * Usage: node scripts/cancel-scheduling-test-bookings.js 1 2 3 4
 */
...
async function main() {
    ...
    if (!ids.length) {
        console.error('Pass booking ids to cancel, e.g. node scripts/cancel-scheduling-test-bookings.js 1 2 3 4');
        process.exit(1);
    }
